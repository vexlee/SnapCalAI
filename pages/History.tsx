...
export const History: React.FC = () => {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      {/* Chart */}
      <Card className="h-80 pt-8 pb-2 px-2">
        {isLoading ? (
                    ...
                    <div key={day.date} className="animate-in slide-in-from-bottom-2 fade-in duration-500">
                        ...
                        >
                            ...
                            <div className="flex items-center gap-3">
                                <span className={`text-sm font-bold bg-white dark:bg-white/5 px-2 py-1 rounded-lg border transition-colors ${
                                    day.totalCalories > dailyGoal 
